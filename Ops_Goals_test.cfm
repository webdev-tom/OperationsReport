...
<cfoutput>
	...
	<cfquery name="getRelevantMetrics" datasource="Corporate">
		SELECT OPS_Column, COALESCE(Goal,0) as Goal 
		FROM OPS_Goals 
		WHERE Company = '#plant#' 
		ORDER BY catgroup, sortorder
	</cfquery>
					  
	<cfset validMetrics = ValueList(getRelevantMetrics.OPS_Column)>
		
	<cfset goalsStruct = StructNew()>
	<cfloop query="getRelevantMetrics">
		<cfset goalsStruct[getRelevantMetrics.OPS_Column] = getRelevantMetrics.Goal>
	</cfloop>
	...
	<nav class="navbar navbar-default navbar-fixed-top">
	  <div class="container-fluid">
		<div class="navbar-header">
			<cfif session.roles eq 'Admin' OR session.roles eq 'Manager'>
			...
			<div class="col-sm-12">
				...
				<div id="mainTabs" style="">	
					<ul class="nav nav-pills" style="display: inline-block;text-align: center">
						<li class="active">
							<a href="##1" data-toggle="tab">Slides</a>
						</li>
						<li>
							<a href="##2" data-toggle="tab">Tiles</a>
						</li>
					</ul>

					<div class="tab-content ">
						<div class="tab-pane active" id="1" style="width: 80%;margin: auto;">
							...
							<div id="goalCarousel" class="carousel slide" data-ride="carousel">
								...
								<div class="carousel-inner" role="listbox">
									...
									<cfloop query="getRelevantMetrics">
										<cfset slideClass = "">
										<cfif getRelevantMetrics.currentrow eq 1>
											<cfset slideClass = " active">
										</cfif>
											
										
										<cfset idname = LCase(ReReplaceNoCase(getRelevantMetrics.OPS_Column,"_","","all"))>
										<cfset displayCategory = REReplaceNoCase(REReplaceNoCase(REReplaceNoCase(REReplaceNoCase(getRelevantMetrics.OPS_Column, chr(95), ' ', 'all'), 'Percent', '%', 'all'), 'Dollar', '$', 'all'), 'Per', '/', 'all')>
										...
										<cfquery name="getDataType" datasource="Corporate">
											SELECT DATA_TYPE 
												...
												WHERE 
													 ...
													 COLUMN_NAME = '#getRelevantMetrics.OPS_Column#'	
										</cfquery>
										...
										<div class="item#slideClass#" style="text-align: center">
											<div class="form-group">
												<label for="#idname#" class="regular" style="text-align: center;font-size: 20px;width: 70% !important;">#displayCategory#</label>
												<input type="text" id="#idname#" class="form-control goalInput" name="#idname#" value="#lsNumberFormat(getRelevantMetrics.Goal,numFormat)#" data-column="#getRelevantMetrics.OPS_Column#" style="text-align: center;margin: 0 auto;height: 80px;font-size: 50px;width: 70% !important;">
					  		...
					  		<div id="entryFormContainer" style="text-align: center">
								<form action="Ops_Goals.cfm" method="put" name="entryForm" id="entryForm">
									...
									<cfloop list="#validMetrics#" index="category">	
										...
										<cfquery name="getGoal" datasource="Corporate">
											SELECT
												OPS_Column,
												Goal
											FROM
