...
<!---
						...
						<div class="hoverdetail" style="width: 150px;height: 100px;position: absolute;background-color: whitesmoke;top: 0;left: 350px;">
							<div id="hdbanner" style="width: 100%;height: 20px;background-color: #1C3D59;color: white;">&nbsp;msf shipped</div>
							<div id="hdleftpanel" style="height: calc(100% - 20px);width: 15px;background-color: #CCDDFE; opacity: 0.7;"></div>
							<span id="msfshippedLast" class="" style="position: absolute;top: 30px;left: 20px;">
									 
											 <span class="posDiff"><i class="fas fa-long-arrow-alt-up"></i> +501</span>
										 <span style="font-style: italic"> from <strong>Feb</strong></span><br>
...
--->
						...
						<div class="row sectionRow" id="#idname#Section">
							...
							<div class="col-sm-6 datacolumn #pullClass#" style="padding: 0px">
								<div id="#idname#Detail" class="#columnClass#Detail">
									<a href="##" class="dataTrigger"><span id="#idname#Value" data-category="#LCase(key)#">#lsNumberFormat(getOps[key][1],numberFormat)##resultDecorationAfter#
									 <div id="#idname#Last" class="lastMonthValue#lmv#" style="min-width: 150px;height: 100px;position: absolute;background-color: whitesmoke;top: 0;">
										<div id="hdbanner" style="width: 100%;height: 20px;background-color: ##1C3D59;color: white;">&nbsp;#LCASE(displayname)#</div>
										<div id="hdleftpanel" style="height: calc(100% - 20px);width: 15px;background-color: ##CCDDFE; opacity: 0.7;"></div>
									 <span style="position: absolute;top: 30px;left: 20px">
									 <cfif theYearMonthNo neq theMinYearMonthNo>
